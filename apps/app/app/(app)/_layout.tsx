...
// before (app-ia §9 additive refactor). Per-screen PRESENTATION is set here (app-ia §4.4): the dashboards
// switcher + paywall are modal routes; kiosk is fullscreen with the gesture-back disabled (its exit lock is
// AOD-11's, design-core-navigation §9). headerShown:false app-wide; the app draws its own AppBar chrome.
